...
@endpush
@section('content')
<div class="bg-gray-100 py-12" id="update-admin-information">
	...
	<div class="container mx-auto px-4">
		<h2 class="font-semibold text-2xl text-gray-600 text-center">Update Admin Information</h2>
		<p class="text-gray-500 mb-6 text-center">Please update the admin's information below.</p>

		<div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
			<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
				<div class="text-gray-600">
					<p class="font-medium text-lg">User Information</p>
					<p>Update the admin's general details.</p>
				</div>
						...
						<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
							...
							<div class="md:col-span-5 text-right">
								<div class="inline-flex items-end">
									<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Update Information</button>
								</div>
							</div>
						</div>
					</form>
