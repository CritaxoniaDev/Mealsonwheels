...
<div class="bg-gray-100 py-12" id="update-volunteer-information">
	...
	<div class="container mx-auto px-4">
		<h2 class="font-semibold text-2xl text-gray-600 text-center">Update Volunteer Information</h2>
		...
		<div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
			<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
				...
				<div class="lg:col-span-2">
					<form action="{{ route('volunteer#updateUserProfile', $userData->id) }}" method="POST">
						@csrf
		...
		<div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
			<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
				...
				<div class="lg:col-span-2">
					<form action="{{ route('volunteer#updateVolunteerProfile', $userData->id) }}" method="POST">
						@csrf
						<div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
							...
							<div class="md:col-span-5">
								<label for="volunteer_available" class="font-bold uppercase">Available Days</label>
