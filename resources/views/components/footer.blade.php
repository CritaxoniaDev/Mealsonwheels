...
<footer class="bg-white footer">
    <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
                <div class="flex justify-center text-teal-600 h-13 sm:justify-start">
                <img src="{{ asset('images/logo.png') }}" alt="Logo" class="rounded-lg">
                </div>

                <p class="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                    Dedicated to providing nutritious meals to seniors and those in need, ensuring that no one goes hungry.
                    Our mission is to promote the health, well-being, and independence of those we serve through community-driven
                    efforts and compassionate care.
                </p>
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        ...
                        <li>
                            <a class="group flex gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="#">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="mailto:john@doe.com">
                                <i class="bi bi-envelope-fill text-gray-900"></i>
                                <span class="flex-1 text-gray-700">mealsonwheels@mow-co.ph</span>
                            </a>
                        </li>

                        <li>
                            <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end" href="tel:0123456789">
                                <i class="bi bi-telephone-fill text-gray-900"></i>
                                <span class="flex-1 text-gray-700">+63 263 534 8675</span>
                            </a>
                        </li>

                        <li class="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                            <i class="bi bi-geo-alt-fill text-gray-900"></i>
                            <address class="-mt-0.5 flex-1 not-italic text-gray-700">
                                Suite 216 al. Sowa 23321, Pyrzyce, MP 16-169
                            </address>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mt-12 border-t border-gray-300 pt-6">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
                <p class="text-sm text-gray-500">
                    ...
                    <a class="inline-block text-teal-600 underline transition hover:text-teal-600/75" href="{{ url('/terms') }}">
                        Terms & Conditions
                    </a>

                    <span>&middot;</span>

                    <a class="inline-block text-teal-600 underline transition hover:text-teal-600/75" href="{{ url('/policy') }}">
                        Privacy Policy
                    </a>
                </p>

                <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Meals on Wheels. Developed by Funsociety Organization</p>
            </div>
        </div>
    </div>
</footer>