...
class OrderController extends Controller
{
    ...
    public function saveOrder(Request $request)
    {
        ...
        return redirect()->route('member#feedback', ['orderId' => $order->id])
            ->with(['orderCreated' => 'Your Order has been placed Successfully! Please provide your feedback.']);
    }

    public function showFeedbackForm($orderId)
    {
        $order = Order::findOrFail($orderId);
        return view('Users.Member.feedback', compact('order'));
    }
